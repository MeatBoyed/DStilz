...
import { BannerSection, CategoriesSection, AboutSection, ViewMoreSection } from '../Lib/HomePage';
...
const Home: NextPage<ViewMoreSectionData> = ({ data }) => {
  return (
    <Container id="HomePage" component="section" maxWidth={false} disableGutters={true}>
      <BannerSection />
      <CategoriesSection />
      <AboutSection />
